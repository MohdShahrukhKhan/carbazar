ActiveAdmin.register Feature do
  ...
  # Filters
  filter :variant, as: :select, collection: Variant.all.pluck(:variant, :id), label: 'Variant'
  ...
  # Form to create/edit a Feature
  form do |f|
    f.inputs 'Feature Details' do
      f.input :variant, as: :select, collection: Variant.all.pluck(:variant, :id), label: 'Variant'
