...
#   permit_params  :car_id, :city_mileage, :fuel_type, :engine_displacement, 
...
#     column :fuel_type
#     column :max_power
#     column :seating_capacity   # Removed the stray backtick here
#     actions
#   end
...
#       # Update car_id input to use a select field
